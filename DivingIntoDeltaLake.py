...
# MAGIC %md 
# MAGIC https://databricks.com/notebooks/gallery/DivingIntoDeltaLake.html
# MAGIC 
# MAGIC # Description: Diving into the Delta Lake Features. This notebook covers Delta Lake Features using the Lending Club data.
